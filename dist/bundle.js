...
async function llmGenerateTags(imagePath, thumbnailPath, signal) {
...
async function indexLibraryTags(tags) {
  const bridge = window.__autoTaggerInference;
...
function dedupeTags(candidateTags, existingTags) {
...
const useSettingsStore = create(
  persist(
    (set) => ({
      ...
      // empty = use built-in default
      llmMaxTokens: 800,
      // output token limit for local models (cloud uses fixed defaults)
      promptPresets: [],
      ...
      try {
        ...
        if (filtered.length) {
          ...
          if (newTags.length) {
            ...
            set((state) => ({
              allItems: state.allItems.map(
                (x) => x.id === item.id ? { ...x, tags: [...x.tags, ...newTags] } : x
              )
            }));
          }
        }
...
const ThumbnailScroller = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 bg-eagle-panel border-r border-eagle-border overflow-y-auto p-3 flex flex-col gap-3 custom-scrollbar [scrollbar-gutter:stable]", children: items.map((item) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        ...
        className: `w-full aspect-square object-cover rounded-lg shadow-md cursor-pointer select-none transition-all duration-200 border-2 ${isActive ? "border-eagle-accent opacity-100" : "border-transparent opacity-60 hover:opacity-100"}`,
        title: item.name
      },
      item.id
    );
...
const ImagePreview = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col p-2 overflow-hidden flex-[5] ", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold mb-2 text-eagle-text", children: "Auto Tag" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-eagle-text-secondary", children: "Preview & edit generated tags" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-eagle-preview rounded-xl border border-eagle-border flex items-center justify-center p-2 relative overflow-hidden shadow-inner", children: [
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-eagle-text-muted italic flex flex-col items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "No image selected" }) }),
...
const TagPicker = ({ onSelect, onMultiSelect, onClose, excludeTags = [], style, multi = false }) => {
  ...
  const canCreate = !multi && trimmed.length > 0 && !excludeSet.has(trimmed.toLowerCase()) && !filtered.some((t) => (typeof t === "string" ? t : t.name).toLowerCase() === trimmed.toLowerCase());
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-eagle-text truncate flex-1", children: name }),
          count != null && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-eagle-text-muted flex-shrink-0", children: [
            "(",
            count,
            ")"
          ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-2 border-b border-eagle-border", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-y-auto max-h-64 custom-scrollbar [scrollbar-gutter:stable]", children: [
            canCreate && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-1.5 border-b border-eagle-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                onClick: () => {
                  onSelect(trimmed);
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-eagle-accent text-sm font-medium", children: "+" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-eagle-text", children: [
                    "Create “",
                    trimmed,
                    "”"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-xs text-eagle-text-muted", children: "↵" })
                ]
              }
            ) }),
            filtered.length === 0 && !canCreate ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-eagle-text-muted text-xs py-6", children: userTags.length === 0 ? "No tags in library" : "No matching tags" }) : filtered.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-1.5 flex flex-col gap-2", children: [
              recent.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "px-2 py-1 text-xs text-eagle-text-muted font-medium", children: [
                  "Recently (",
                  recent.length,
                  ")"
                ] }),
...
const Sidebar = ({ activeSection, onTabChange }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "bg-eagle-elevated border-r border-eagle-border flex-col py-4 hidden md:flex", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "px-4 text-xl font-bold text-eagle-accent mb-4", children: "AI Image Tagger" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex-1 space-y-1", children: tabs.map(({ name, id }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "li",
    {
      onClick: () => onTabChange(id),
      className: `px-4 py-2 cursor-pointer transition-colors border-l-4 select-none ${activeSection === id ? "bg-eagle-btn-bg text-eagle-text border-eagle-accent" : "text-eagle-text-secondary border-transparent hover:bg-eagle-btn-hover"}`,
      children: name
    },
    id
  )) })
] });
const DEFAULT_PROMPT = `IMPORTANT: Output ONLY valid JSON. NO explanations, NO markdown, NO extra text.Analyze this image and generate 15-25 accurate Danbooru-style tags.
...
const Section = ({ title, children }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold uppercase tracking-widest text-eagle-text-secondary mb-3 pb-2 border-b border-eagle-border", children: title }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-4", children })
] });
const Field = ({ label, hint, children }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-eagle-text", children: label }),
  children,
  hint && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-eagle-text-muted", children: hint })
] });
const TextInput = ({ value, onChange, placeholder, type = "text" }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "input",
  {
    type,
    value,
...
const Toggle = ({ checked, onChange, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-3 cursor-pointer w-fit select-none", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-10 h-6 rounded-full border transition-colors ${checked ? "bg-eagle-primary border-eagle-primary" : "bg-eagle-btn-bg border-eagle-border"}` }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute top-1 w-4 h-4 bg-white rounded-full shadow transition-transform ${checked ? "translate-x-5" : "translate-x-1"}` })
  ] }),
...
const Settings = () => {
  ...
  const [blacklistInput, setBlacklistInput] = reactExports.useState("");
  const [showBlacklistPicker, setShowBlacklistPicker] = reactExports.useState(false);
  const blacklistPickerBtnRef = reactExports.useRef(null);
  const [blacklistPickerStyle, setBlacklistPickerStyle] = reactExports.useState({});
  const [newPresetName, setNewPresetName] = reactExports.useState("");
  const [addingPreset, setAddingPreset] = reactExports.useState(false);
  const [selectedPresetIdx, setSelectedPresetIdx] = reactExports.useState("__default__");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-6 custom-scrollbar [scrollbar-gutter:stable]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-eagle-text", children: "Plugin Settings" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "General", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Field, { label: "Tag blacklist", hint: "Tags in this list are never added, regardless of inference mode.", children: [
        ...
        showBlacklistPicker && /* @__PURE__ */ jsxRuntimeExports.jsx(
          TagPicker,
          {
            onSelect: (tag) => {
        ...
        tagBlacklist.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mt-1", children: tagBlacklist.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 bg-eagle-btn-bg border border-eagle-border rounded px-2 py-0.5 text-xs text-eagle-text", children: [
          tag,
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "LLM Settings", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Provider", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 p-1 bg-eagle-btn-bg rounded-lg w-fit border border-eagle-border", children: [["openai", "OpenAI"], ["anthropic", "Anthropic"], ["local", "Local"]].map(([p, label]) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => update({ llmProvider: p }),
          className: `px-4 py-1.5 rounded-md text-sm font-medium transition-colors ${llmProvider === p ? "bg-eagle-primary text-white" : "text-eagle-text-secondary hover:text-eagle-text"}`,
          children: label
        },
        p
      )) }) }),
      llmProvider === "local" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        Field,
        {
          label: "Endpoint",
        ...
        {
          label: "API key",
          hint: llmProvider === "openai" ? "Your OpenAI API key (sk-…). Stored locally in plugin settings." : "Your Anthropic API key (sk-ant-…). Stored locally in plugin settings.",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            TextInput,
            {
              type: "password",
      ...
      llmProvider === "local" && /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Max output tokens", hint: "Caps the model's response length. 800 is enough for 25 tags. Raise this for reasoning models that emit chain-of-thought before the JSON.", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextInput,
        {
          type: "number",
          ...
          onChange: (v) => {
            const n = parseInt(v);
            if (!isNaN(n) && n > 0) update({ llmMaxTokens: n });
          },
          placeholder: "800"
        }
      ) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "__default__", children: "Default" }),
                promptPresets.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: String(i), children: p.name }, i))
              ]
            }
          ),
          !addingPreset ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: savePreset, className: "px-3 py-2 bg-eagle-primary hover:bg-eagle-primary-hover text-white rounded-lg text-sm transition-colors", children: "Save" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setAddingPreset(false), className: "px-3 py-2 bg-eagle-btn-bg hover:bg-eagle-btn-hover border border-eagle-border rounded-lg text-sm text-eagle-text transition-colors", children: "Cancel" })
          ] }),
          selectedPresetIdx !== "__default__" && !addingPreset && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => {
...
const useLatest = (current) => {
  const storedValue = reactExports.useRef(current);
  reactExports.useEffect(() => {
...
function useForceUpdate() {
  const setState = reactExports.useState(emptyObj)[1];
  return reactExports.useRef(() => setState({})).current;
}
const emptyObj = {};
const __reactCreateElement__ = reactExports.createElement;
function useMasonry(_ref) {
  ...
  const children = [];
  const itemRole = role === "list" ? "listitem" : role === "grid" ? "gridcell" : void 0;
...
let didEverMount = "0";
const createRenderElement = /* @__PURE__ */ memoize([OneKeyMap, {}, WeakMap, OneKeyMap], (RenderComponent, index, data, columnWidth) => /* @__PURE__ */ __reactCreateElement__(RenderComponent, {
  index,
  data,
  width: columnWidth
}));
const getContainerStyle = /* @__PURE__ */ memoOne((isScrolling, estimateHeight) => ({
  position: "relative",
  width: "100%",
  maxWidth: "100%",
...
const assignUserStyle = /* @__PURE__ */ memoOne(
...
const getCachedSize = /* @__PURE__ */ memoOne((width) => ({
  width,
  zIndex: -1e3,
  visibility: "hidden",
  position: "absolute",
...
const getRefSetter = /* @__PURE__ */ memoOne(
  (positioner, resizeObserver) => (index) => (el2) => {
    if (el2 === null) return;
    if (resizeObserver) {
      resizeObserver.observe(el2);
      elementsCache.set(el2, index);
    }
    if (positioner.get(index) === void 0) positioner.set(index, el2.offsetHeight);
  },
  // @ts-expect-error
  cmp2
);
function usePositioner(_ref, deps) {
  ...
  const positionerRef = reactExports.useRef();
  if (positionerRef.current === void 0) positionerRef.current = initPositioner();
  const prevDeps = reactExports.useRef(deps);
  const opts = [width, columnWidth, columnGutter, rowGutter, columnCount, maxColumnCount, maxColumnWidth];
  const prevOpts = reactExports.useRef(opts);
    ...
    update: (updates) => {
      ...
      for (i = 0; i < columns.length; i++) {
        ...
        for (j = startIndex + 1; j < itemsInColumn.length; j++) {
          const index2 = itemsInColumn[j];
          const item = items[index2];
          item.top = columnHeights[i];
          columnHeights[i] = item.top + item.height + rowGutter;
          intervalTree.remove(index2);
          intervalTree.insert(item.top, item.top + item.height, index2);
        }
      }
    },
...
const getColumns = function(width, minimumWidth, gutter, columnCount, maxColumnCount, maxColumnWidth) {
  ...
  let columnWidth = Math.floor((width - gutter * (columnCount - 1)) / columnCount);
  if (maxColumnWidth !== void 0 && columnWidth > maxColumnWidth) {
    columnWidth = maxColumnWidth;
  }
  return [columnWidth, columnCount];
};
const emptyArr = [];
const GalleryCtx = reactExports.createContext(null);
const AspectBox = ({ ratio, children }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "relative", paddingBottom: `${1 / ratio * 100}%` }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", inset: 0 }, children }) });
const Thumbnail = reactExports.memo(({ src, fallback, alt, ratio }) => {
  const [currentSrc, setCurrentSrc] = reactExports.useState(src || fallback);
  const [broken, setBroken] = reactExports.useState(!src && !fallback);
  if (broken) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(AspectBox, { ratio, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full bg-eagle-btn-bg border border-eagle-border flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-6 h-6 text-eagle-text-muted", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "path",
      {
        strokeLinecap: "round",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AspectBox, { ratio, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "img",
    {
      src: currentSrc,
      alt,
...
const CheckIcon = () => /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-3 h-3 text-white", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: 2.5, children: /* @__PURE__ */ jsxRuntimeExports.jsx("polyline", { points: "2,6 5,9 10,3" }) });
const GalleryCard = reactExports.memo(({ data: item }) => {
  const { selectedIds, onItemClick, onCheckboxClick, selectMode } = reactExports.useContext(GalleryCtx);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      title: item.name,
      className: `group cursor-pointer rounded-lg overflow-hidden border-2 transition-all duration-150 ${isSelected ? "border-eagle-accent" : "border-transparent hover:border-eagle-border"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Thumbnail, { src: item.thumbnailPath, fallback: item.filePath, alt: item.name, ratio }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors pointer-events-none" }),
          isSelected && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-eagle-accent/20 pointer-events-none" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `absolute top-1.5 left-1.5 transition-opacity ${isSelected || selectMode ? "opacity-100" : "opacity-0 group-hover:opacity-100"}`,
              onClick: (e) => {
                e.stopPropagation();
                onCheckboxClick(item);
              },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-5 h-5 rounded border-2 flex items-center justify-center transition-colors ${isSelected ? "bg-eagle-accent border-eagle-accent" : "bg-black/40 border-white/60"}`, children: isSelected && /* @__PURE__ */ jsxRuntimeExports.jsx(CheckIcon, {}) })
            }
          ),
          isUntagged && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-orange-400 shadow", title: "Untagged" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-1.5 py-1 bg-eagle-panel", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-eagle-text truncate leading-tight", children: item.name }),
          item.width && item.height && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-eagle-text-muted", children: [
            item.width,
            " × ",
            item.height
          ] })
...
const DivMasonry = ({ items, containerRef, columnWidth = 160 }) => {
  ...
  const scrollTimer = reactExports.useRef(null);
  reactExports.useEffect(() => {
...
const Gallery = () => {
  ...
  const handleCheckboxClick = reactExports.useCallback((item) => {
    if (batchProgress) return;
    const idx = filteredItems.findIndex((x) => x.id === item.id);
    setSelectedIds((prev) => {
      const next = new Set(prev);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-2 border-b border-eagle-border bg-eagle-panel flex items-center gap-2 flex-wrap", children: [
      ...
      batchProgress && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 w-full", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-eagle-text-secondary tabular-nums", children: [
...
class ErrorBoundary extends reactExports.Component {
  ...
  render() {
    if (this.state.error) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center gap-4 p-8 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-eagle-text font-semibold", children: "Something crashed" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "text-xs text-eagle-text-muted bg-eagle-btn-bg border border-eagle-border rounded-lg p-3 max-w-lg overflow-auto text-left whitespace-pre-wrap", children: this.state.error.message }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex h-screen overflow-hidden bg-eagle-main text-eagle-text font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, { activeSection, onTabChange: setActiveSection }),
    activeSection === "auto" && /* @__PURE__ */ jsxRuntimeExports.jsx(ThumbnailScroller, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex flex-col bg-eagle-main overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ErrorBoundary, { children: [
      activeSection === "auto" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ImagePreview, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TagPanel, {})
      ] }),
      activeSection === "gallery" && /* @__PURE__ */ jsxRuntimeExports.jsx(Gallery, {}),
      activeSection === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, {})
    ] }) })
  ] });
}
const el = document.getElementById("root");
if (!el) throw new Error("Missing root element");
clientExports.createRoot(el).render(
